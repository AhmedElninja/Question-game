...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) {
        let currentIndex = stories[currentStory]
        if userChoice == currentIndex.choice1 {
            currentStory = currentIndex.choice1Destination
        } else if userChoice == currentIndex.choice2 {
            currentStory = currentIndex.choice2Destination
        }
    }
